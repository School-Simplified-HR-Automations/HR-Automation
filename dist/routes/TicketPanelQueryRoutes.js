...
class TicketPanelQueryRoutes {
     ...
     */
    getTicketPanel(queryPointer, value, limit = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            if (limit == 0) {
                return __1.dbSql.query(`SELECT *
            FROM ticketpanels
            WHERE ${queryPointer} = '${value}'`, { type: sequelize_1.QueryTypes.SELECT });
            }
            else {
                return __1.dbSql.query(`SELECT *
            FROM ticketpanels
            WHERE ${queryPointer} = '${value}'
            LIMIT ${limit}`, { type: sequelize_1.QueryTypes.SELECT });
            }
        });
    }
    /**
     ...
     * @returns Array of Ticket Panels.
     */
    listTicketPanels(limit = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            if (limit == 0) {
                return __1.dbSql.query(`SELECT * FROM ticketpanels`, { type: sequelize_1.QueryTypes.SELECT });
            }
            else {
                return __1.dbSql.query(`SELECT * FROM ticketpanels LIMIT ${limit}`, { type: sequelize_1.QueryTypes.SELECT });
            }
        });
    }
    /**
     ...
     * @returns Array of Ticket Panels.
     */
    listTicketPanelsGuild(guildId, limit = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            if (limit == 0) {
                return __1.dbSql.query(`SELECT * FROM ticketpanels WHERE guildId = '${guildId}'`, { type: sequelize_1.QueryTypes.SELECT });
            }
            else {
                return __1.dbSql.query(`SELECT * FROM ticketpanels WHERE guildId = '${guildId}' LIMIT ${limit}`, { type: sequelize_1.QueryTypes.SELECT });
            }
        });
    }
    /**
     ...
     */
    createTicketPanel(name, value, description, channelPrefix, guildId, buttonName, tpguid, messageLink, category, logChannel) {
        return __awaiter(this, void 0, void 0, function* () {
            __1.dbSql.query(`INSERT INTO ticketpanels (
     ...
     */
    deleteTicketPanel(queryPointer, value, limit = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            if (limit == 0) {
                __1.dbSql.query(`DELETE FROM ticketpanels WHERE ${queryPointer} = '${value}'`);
                return;
            }
            else {
                __1.dbSql.query(`DELETE FROM ticketpanels WHERE ${queryPointer} = '${value}' LIMIT ${limit}`);
                return;
            }
        });
    }
}
exports.default = TicketPanelQueryRoutes;
