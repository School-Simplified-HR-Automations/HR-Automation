...
class TeamQueryRoutes {
    getTeam(filter) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const querystr = (0, queryBuilder_1.default)('SELECT * FROM teams', filters, 1);
    ...
    getTeamStaff(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < res.length; i++) {
                let pos = yield this.getTeam({ id: res[i].TeamId });
                ret.push(pos.name);
            }
            return ret;
        });
...
exports.default = TeamQueryRoutes;
